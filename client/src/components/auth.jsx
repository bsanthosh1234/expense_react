...
export default function Auth() {
  ...
  // const server = "https://accounts.bhanuk19.repl.co/";
  // const server="http://192.168.1.17:3050"
  const server="https://backflipt-accounts.onrender.com"
  // const server="https://backflipt-accounts.bhanuk19.repl.co"
      ...
      axios
        ...
        .then((res) => {
          if (res.data[0]) {
            ...
            window.location.href = server + "/?app=expenses";
          }
        });
      return;
    } else {
